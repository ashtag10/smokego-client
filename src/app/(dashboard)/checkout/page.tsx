          ...
          <div className="flex flex-col gap-5">
            <div>
              ...
              <p className="mt-2 max-w-xl text-[13px] text-gray-500">
                Vérifiez votre sélection avant de choisir votre adresse et
              ...
              <div className="p-5 md:p-6">
                  ...
                  <div className="flex items-end justify-between gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-[24px] font-bold text-black">
                        {cart.total}
                        <span className="ml-1 text-[14px] font-medium text-purple-600">
                          FCFA
                        </span>
                      </p>
                    </div>
                ...
                <div className="mt-4 flex items-start gap-2.5 rounded-lg border border-gray-200 bg-gray-50 p-3">
                  ...
                  <p className="text-[11px] leading-relaxed text-gray-600">
                    À l'étape suivante, vous pourrez sélectionner ou
                    ajouter votre adresse de livraison.
                  </p>
                </div>
              </div>
            </div>
